...
I used DATASCI 350 lecture notes from Lectures 2-8 to complete this quiz. I used OpenAI Codex only to review commands and answers I wrote myself, not to generate solutions.